    ...
    return (
        <div className={'w-full flex flex-row justify-between'}>
            <div className={'flex flex-col lg:flex-row-reverse lg:max-w-[1277px] lg:gap-[20px] px-[20px] lg:px-[70px] xl:px-[100px] mx-auto items-center'}>
                <div className={'w-full lg:w-1/2 lg:max-w-[660px]'}>
                ...
                <div className={'w-full lg:w-1/2 lg:max-w-[597px]'}>
                    ...
                    <button className={'flex gap-2 items-center my-[20px] lg:my-[50px] bg-[#141313] text-white font-medium text-[14px] lg:text-[18px] h-[32px] lg:h-[56px] px-[30px]'}>Let's talk with me
            ...
            <div className={'w-[50px] bg-blue-50 h-screen'}></div>
        </div>
    );
};
